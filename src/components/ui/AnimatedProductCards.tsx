...
const AnimatedProductCards = () => {
  ...
  const transform0 = {
    x: useTransform(scrollYProgress, [0.0, 0.4], [0, -400]),
    y: useTransform(scrollYProgress, [0.0, 0.4], [200, Math.sin(0 * 0.5) * 20]),
    rotate: useTransform(scrollYProgress, [0.0, 0.4], [0, -16]),
  };
        ...
        <div className="relative flex items-start justify-center w-full h-full">
          {cards.map((card, index) => {
            ...
            return (
              ...
              >
                <motion.div
                  className="w-[200px] h-[350px] md:w-[300px] md:h-[450px] relative preserve-3d shadow-[-12px_-3px_14.6px_0px_rgba(0,_0,_0,_0.2)] rounded-lg border border-primary/20"
